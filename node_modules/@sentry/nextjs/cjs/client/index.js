...
function maybeUpdateBrowserTracingIntegration(integrations) {
  ...
  if (browserTracing && !(browserTracing instanceof browserTracingIntegration.BrowserTracing)) {
...
function getDefaultIntegrations(options) {
  ...
  if (typeof __SENTRY_TRACING__ === 'undefined' || __SENTRY_TRACING__) {
    if (core.hasTracingEnabled(options)) {
      customDefaultIntegrations.push(new browserTracingIntegration.BrowserTracing());
    }
  }
