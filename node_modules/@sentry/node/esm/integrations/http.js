...
import { parseSemver, logger, fill, isMatchingPattern, dynamicSamplingContextToSentryBaggageHeader } from '@sentry/utils';
...
function _createWrappedRequestMethodFactory(
  ...
  const shouldCreateSpan = (url) => {
    if (_optionalChain([options, 'optionalAccess', _6 => _6.shouldCreateSpanForRequest]) === undefined) {
      return true;
    }
  ...
  const shouldAttachTraceData = (url) => {
    if (_optionalChain([options, 'optionalAccess', _7 => _7.tracePropagationTargets]) === undefined) {
      return true;
    }
